...
namespace Substrate.NetApi.NetApiExt.Generated.Storage
{
    ...
    public sealed class SessionStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Session", "Validators"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Session", "QueuedKeys"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.NetApiExt.Generated.Model.opal_runtime.runtime_common.SessionKeys>>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Session", "NextKeys"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.NetApi.NetApiExt.Generated.Model.opal_runtime.runtime_common.SessionKeys)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Session", "KeyOwner"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.KeyTypeId, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>>), typeof(Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32)));
        }
        ...
        ///  The current set of validators.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>> Validators(string blockhash, CancellationToken token)
        {
        ...
        ///  will be used to determine the validator's session keys.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.NetApiExt.Generated.Model.opal_runtime.runtime_common.SessionKeys>>> QueuedKeys(string blockhash, CancellationToken token)
        {
            string parameters = SessionStorage.QueuedKeysParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.NetApiExt.Generated.Model.opal_runtime.runtime_common.SessionKeys>>>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string NextKeysParams(Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  The next session keys for a validator.
        /// </summary>
        public async Task<Substrate.NetApi.NetApiExt.Generated.Model.opal_runtime.runtime_common.SessionKeys> NextKeys(Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = SessionStorage.NextKeysParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.NetApiExt.Generated.Model.opal_runtime.runtime_common.SessionKeys>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string KeyOwnerParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.KeyTypeId, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> key)
        {
        ...
        ///  The owner of a key. The key is the `KeyTypeId` + the encoded key.
        /// </summary>
        public async Task<Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> KeyOwner(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.KeyTypeId, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class SessionCalls
    {
        ...
        /// </summary>
        public static Method SetKeys(Substrate.NetApi.NetApiExt.Generated.Model.opal_runtime.runtime_common.SessionKeys keys, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8> proof)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(keys.Encode());
            byteArray.AddRange(proof.Encode());
            return new Method(24, "Session", 0, "set_keys", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(24, "Session", 1, "purge_keys", byteArray.ToArray());
        }
    }
