...
namespace Substrate.NetApi.NetApiExt.Generated.Storage
{
    ...
    public sealed class AppPromotionStorage
    {
        ...
        public AppPromotionStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AppPromotion", "Admin"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AppPromotion", "Staked"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>), typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U128, Substrate.NetApi.Model.Types.Primitive.U32>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AppPromotion", "StakesPerAccount"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.NetApi.Model.Types.Primitive.U8)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AppPromotion", "PendingUnstake"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.NetApi.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT42)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AppPromotion", "PreviousCalculatedRecord"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>)));
        }
        ...
        ///  Stores the `admin` account. Some extrinsics can only be executed if they were signed by `admin`.
        /// </summary>
        public async Task<Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> Admin(string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string StakedParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32> key)
        {
        ...
        ///  The number of the relay block in which we must perform the interest recalculation
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U128, Substrate.NetApi.Model.Types.Primitive.U32>> Staked(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32> key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string StakesPerAccountParams(Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  * **Value** - Amount of stakes.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U8> StakesPerAccount(Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
        ...
        ///  * **Value** - Amount of stakes.
        /// </summary>
        public async Task<Substrate.NetApi.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT42> PendingUnstake(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = AppPromotionStorage.PendingUnstakeParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT42>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  If `None`, then recalculation has not yet been performed or calculations have been completed for all stakers.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>> PreviousCalculatedRecord(string blockhash, CancellationToken token)
        {
            string parameters = AppPromotionStorage.PreviousCalculatedRecordParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class AppPromotionCalls
    {
        ...
        /// </summary>
        public static Method SetAdminAddress(Substrate.NetApi.NetApiExt.Generated.Model.pallet_evm.account.EnumBasicCrossAccountIdRepr admin)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SponsorCollection(Substrate.NetApi.NetApiExt.Generated.Model.up_data_structs.CollectionId collection_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method StopSponsoringCollection(Substrate.NetApi.NetApiExt.Generated.Model.up_data_structs.CollectionId collection_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(collection_id.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SponsorContract(Substrate.NetApi.NetApiExt.Generated.Model.primitive_types.H160 contract_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method StopSponsoringContract(Substrate.NetApi.NetApiExt.Generated.Model.primitive_types.H160 contract_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(contract_id.Encode());
    ...
    public sealed class AppPromotionConstants
    {
        ...
        /// </summary>
        public Substrate.NetApi.NetApiExt.Generated.Model.frame_support.PalletId PalletId()
        {
            var result = new Substrate.NetApi.NetApiExt.Generated.Model.frame_support.PalletId();
        ...
        /// </summary>
        public Substrate.NetApi.NetApiExt.Generated.Types.Base.Arr16U8 FreezeIdentifier()
        {
            var result = new Substrate.NetApi.NetApiExt.Generated.Types.Base.Arr16U8();
        ...
        /// </summary>
        public Substrate.NetApi.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill IntervalIncome()
        {
            var result = new Substrate.NetApi.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill();
