...
namespace Substrate.NetApi.NetApiExt.Generated.Storage
{
    ...
    public sealed class EvmMigrationStorage
    {
        ...
        public EvmMigrationStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("EvmMigration", "MigrationPending"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.NetApiExt.Generated.Model.primitive_types.H160), typeof(Substrate.NetApi.Model.Types.Primitive.Bool)));
        }
        
        /// <summary>
        /// >> MigrationPendingParams
        /// </summary>
        public static string MigrationPendingParams(Substrate.NetApi.NetApiExt.Generated.Model.primitive_types.H160 key)
        {
        ...
        /// >> MigrationPending
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.Bool> MigrationPending(Substrate.NetApi.NetApiExt.Generated.Model.primitive_types.H160 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class EvmMigrationCalls
    {
        ...
        /// </summary>
        public static Method Begin(Substrate.NetApi.NetApiExt.Generated.Model.primitive_types.H160 address)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetData(Substrate.NetApi.NetApiExt.Generated.Model.primitive_types.H160 address, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.NetApiExt.Generated.Model.primitive_types.H256, Substrate.NetApi.NetApiExt.Generated.Model.primitive_types.H256>> data)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(address.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Finish(Substrate.NetApi.NetApiExt.Generated.Model.primitive_types.H160 address, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8> code)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(address.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method InsertEthLogs(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.NetApiExt.Generated.Model.ethereum.log.Log> logs)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
