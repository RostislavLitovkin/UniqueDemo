...
namespace Substrate.NetApi.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue
{
    ...
    /// <summary>
    /// >> 549 - Composite[cumulus_pallet_xcmp_queue.OutboundChannelDetails]
    /// </summary>
    ...
    public sealed class OutboundChannelDetails : BaseType
    {
        ...
        /// >> recipient
        /// </summary>
        public Substrate.NetApi.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id Recipient { get; set; }
        /// <summary>
        /// >> state
        /// </summary>
        public Substrate.NetApi.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState State { get; set; }
        /// <summary>
        /// >> signals_exist
        /// </summary>
        ...
        {
            var start = p;
            Recipient = new Substrate.NetApi.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id();
            Recipient.Decode(byteArray, ref p);
            State = new Substrate.NetApi.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState();
