...
namespace Substrate.NetApi.NetApiExt.Generated.Model.up_data_structs
{
    ...
    public sealed class RpcCollection : BaseType
    {
        ...
        /// >> owner
        /// </summary>
        public Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 Owner { get; set; }
        /// <summary>
        /// >> mode
        /// </summary>
        ...
        /// >> sponsorship
        /// </summary>
        public Substrate.NetApi.NetApiExt.Generated.Model.up_data_structs.EnumSponsorshipState Sponsorship { get; set; }
        /// <summary>
        /// >> limits
        /// </summary>
        public Substrate.NetApi.NetApiExt.Generated.Model.up_data_structs.CollectionLimits Limits { get; set; }
        /// <summary>
        /// >> permissions
        /// </summary>
        public Substrate.NetApi.NetApiExt.Generated.Model.up_data_structs.CollectionPermissions Permissions { get; set; }
        /// <summary>
        /// >> token_property_permissions
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.NetApiExt.Generated.Model.up_data_structs.PropertyKeyPermission> TokenPropertyPermissions { get; set; }
        /// <summary>
        /// >> properties
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.NetApiExt.Generated.Model.up_data_structs.Property> Properties { get; set; }
        /// <summary>
        /// >> read_only
        /// </summary>
        ...
        /// >> flags
        /// </summary>
        public Substrate.NetApi.NetApiExt.Generated.Model.up_data_structs.RpcCollectionFlags Flags { get; set; }
        ...
        {
            var start = p;
            Owner = new Substrate.NetApi.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
            ...
            Sponsorship = new Substrate.NetApi.NetApiExt.Generated.Model.up_data_structs.EnumSponsorshipState();
            Sponsorship.Decode(byteArray, ref p);
            Limits = new Substrate.NetApi.NetApiExt.Generated.Model.up_data_structs.CollectionLimits();
            Limits.Decode(byteArray, ref p);
            Permissions = new Substrate.NetApi.NetApiExt.Generated.Model.up_data_structs.CollectionPermissions();
            Permissions.Decode(byteArray, ref p);
            TokenPropertyPermissions = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.NetApiExt.Generated.Model.up_data_structs.PropertyKeyPermission>();
            TokenPropertyPermissions.Decode(byteArray, ref p);
            Properties = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.NetApiExt.Generated.Model.up_data_structs.Property>();
            Properties.Decode(byteArray, ref p);
            ReadOnly = new Substrate.NetApi.Model.Types.Primitive.Bool();
            ReadOnly.Decode(byteArray, ref p);
            Flags = new Substrate.NetApi.NetApiExt.Generated.Model.up_data_structs.RpcCollectionFlags();
