...
namespace Substrate.NetApi.NetApiExt.Generated.Model.up_data_structs
{
    ...
    public sealed class CreateRefungibleExSingleOwner : BaseType
    {
        ...
        /// >> user
        /// </summary>
        public Substrate.NetApi.NetApiExt.Generated.Model.pallet_evm.account.EnumBasicCrossAccountIdRepr User { get; set; }
        /// <summary>
        /// >> pieces
        /// </summary>
        ...
        {
            var start = p;
            User = new Substrate.NetApi.NetApiExt.Generated.Model.pallet_evm.account.EnumBasicCrossAccountIdRepr();
